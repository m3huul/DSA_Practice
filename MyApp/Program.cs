...
public class Test
{
  public static void Main(string[] args)
  {
    ...
    int? searchQuery = int.TryParse(Console.ReadLine(), out int searchValue) ? searchValue : null;
    ...
    int? deleteQuery = int.TryParse(Console.ReadLine(), out int deleteValue) ? deleteValue : null;
