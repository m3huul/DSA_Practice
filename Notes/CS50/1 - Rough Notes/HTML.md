...
- `<html lang="en"> ... </html>` : This is a tag in html, the tag name in this context is html. The tags used in html will always have a closing tag `</html>` unlike `<!DOCTYPE html>` which is a 